...
export default function CareerMain() {
    ...
    <Grid  md={6}>
    <Typography variant="h4">Our Working Culture</Typography>
    <Typography>At Durdans Hospital, we aim to build a talent pool of friendly and passionate team members who are as dedicated as we are to providing world-class care and support services.<br/><br/>
